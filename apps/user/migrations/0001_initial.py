# Generated by Django 5.1.6 on 2025-03-13 12:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('EMPLOYEE', 'Employee'), ('HR', 'Human resources')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('is_delete', models.BooleanField(default=False)),
                ('user_profile', models.ImageField(blank=True, null=True, upload_to='media/userprofile')),
                ('email_address', models.EmailField(blank=True, max_length=254, null=True)),
                ('alternative_address', models.EmailField(blank=True, max_length=254, null=True)),
